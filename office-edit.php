...
<head>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $query_update = "UPDATE office SET name = '$name', contactnum = '$contact_num', email = '$email', address = '$address', city = '$city', country = '$country', postal = $postal WHERE id = $id";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $contact_num ?>" name="contactnum">
                                            </div>
                                        </div>
